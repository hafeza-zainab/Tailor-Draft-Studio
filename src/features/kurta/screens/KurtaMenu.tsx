// src/features/kurta/screens/KurtaMenu.tsx
...
export default function KurtaMenu() {
  const navigation = useNavigation<any>();

  const menuItems: MenuItem[] = [
    {
      title: 'New Kurta Draft',
      subtitle: 'Enter custom measurements',
      icon: 'shirt-outline' as const,
      screen: 'KurtaDraftInput',
      color: COLORS.primary,
    },
    {
      title: 'Saved Kurta Drafts',
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Kurta Studio</Text>
